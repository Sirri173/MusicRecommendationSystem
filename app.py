...
music_dict = pickle.load(open(r'F:\Face Mask Detection\music_rec_system\musicrec.pkl', 'rb'))
music = pd.DataFrame(music_dict)

similarity = pickle.load(open(r'F:\Face Mask Detection\music_rec_system\similarities.pkl', 'rb'))
